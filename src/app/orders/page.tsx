      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-3xl font-bold text-red-600">277</p>
          </div>
        </div>
              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  <tr>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">TechStore</td>
                  ...
                  <tr>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">FashionStore</td>
                  ...
                  <tr>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">HomeStore</td>
                  ...
                  <tr>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">#ORD-12348</td>
