...
function ApplicationsContent() {
  ...
  }, [page, statusFilter, searchTerm, jobIdParam]);
  ...
  if (!canManage) {
    return (
      <div className="bg-white rounded-lg shadow p-8 text-center">
        <h2 className="text-xl font-semibold mb-2">Career · Applications</h2>
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">
          Review candidates who applied via the career portal
          {jobIdParam ? ' (filtered by job)' : ''}.
        </p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="p-4 border-b flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
          ...
          <div className="flex gap-2 flex-wrap">
            {jobIdParam && (
              <button
                onClick={() => router.push('/career/applications')}
            ...
            <div className="rounded-lg bg-gray-50 p-3 text-sm space-y-1.5">
              ...
              {selected.linkedin && (
                <p>
                  ...
                  <a href={selected.linkedin} target="_blank" rel="noreferrer" className="text-blue-600">
                    {selected.linkedin}
                  </a>
                </p>
              )}
              {selected.github && (
                <p>
                  ...
                  <a href={selected.github} target="_blank" rel="noreferrer" className="text-blue-600">
                    {selected.github}
                  </a>
                </p>
              )}
              {selected.portfolio && (
                <p>
                  ...
                  <a href={selected.portfolio} target="_blank" rel="noreferrer" className="text-blue-600">
                    {selected.portfolio}
                  </a>
                </p>
              )}
              {selected.resumeUrl && (
                <p>
                  ...
                  <a href={selected.resumeUrl} target="_blank" rel="noreferrer" className="text-blue-600">
